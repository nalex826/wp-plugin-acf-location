...
if (! class_exists('custom_loc_field_select')) {
    class custom_loc_field_select extends acf_field
    {
        /*
        *  __construct
        *
        ...
        */
        ...
        public function format_value_single($value, $post_id, $field)
        {
            ...
            // value
            if ('value' == $field['return_format']) {
                // do nothing

                // label
            } elseif ('label' == $field['return_format']) {
                $value = $label;
    ...
    // initialize
    new custom_loc_field_select($this->settings);
